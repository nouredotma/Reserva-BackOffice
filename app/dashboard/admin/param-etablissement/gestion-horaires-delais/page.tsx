    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-white rounded-lg shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto animate-slideUp">
        ...
        <div className="sticky bottom-0 bg-white border-t border-gray-100 px-6 py-4 flex gap-3">
          ...
          <button onClick={handleSubmit} className="flex-1 px-6 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-gray-800 transition-colors">Enregistrer</button>
        </div>
      </div>
    </div>
  );
...
const GestionHoraires = () => {
  ...
  const [exceptionalSchedules, setExceptionalSchedules] = useState<ExceptionalSchedule[]>([
    { id: 1, date: '2024-10-17', isOpen: true, openTime: '10:00', closeTime: '18:00', reason: 'Fermeture anticipée' },
    { id: 2, date: '2024-04-22', isOpen: false, reason: 'Jour férié' },
    { id: 3, date: '2024-04-17', isOpen: true, openTime: '09:00', closeTime: '19:00', reason: 'Horaire spécial' }
  ]);
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            {activeTab === 'establishment' && (
              <button className="px-6 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-gray-800 transition-colors flex items-center gap-2">
                <Save size={16} />
                Enregistrer
              </button>
            )}
