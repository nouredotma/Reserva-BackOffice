  ...
  return (
    <div className="min-h-screen p-0 md:p-0 max-w-[2000px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Receive an email as soon as an online reservation is created, updated, or canceled
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto animate-fadeIn p-0">
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-2">Add an email address</label>
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-5 py-3 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-colors flex items-center gap-2"
            >
              <Plus size={16} />
              Add
            </button>
