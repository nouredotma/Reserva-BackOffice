        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Do you want to enable the waitlist?
            </p>
          </div>
          <button className="px-6 py-3 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-all flex items-center gap-2">
            Save
          </button>
        </div>
      </div>
...
export default GestionListAttentePage;
