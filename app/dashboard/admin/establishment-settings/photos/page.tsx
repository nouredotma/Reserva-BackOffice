...
const PhotoManagement = () => {
  ...
  const handleDownloadSelected = () => {
    alert(`Uploading ${selectedPhotos.length} photo(s)...`);
  };
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files && files.length > 0) {
      ...
      alert(`${files.length} photo(s) imported`);
      ...
      <div className="p-0 md:p-0 max-w-[2000px] mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Organize and manage your photos professionally
              </p>
            </div>
            <button
        ...
        {filteredPhotos.length === 0 ? (
          <div className="text-center py-20 animate-fadeIn">
            ...
            <h3 className="text-xl font-light text-gray-900 mb-2">No photo found</h3>
            ...
            {!searchQuery && (
              <button
                onClick={() => setShowUploadModal(true)}
                className="px-6 py-3 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-all inline-flex items-center gap-2"
              >
                <Upload size={18} />
                Importer des photos
              </button>
              ...
              >
                ...
                <div className="p-4 pb-2">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-500 mb-3">
                    <Calendar size={12} />
                    <span>{photo.date.toLocaleDateString('en-US')}</span>
                    <span>•</span>
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200 animate-fadeIn">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600">
                <span className="font-medium text-gray-900">{filteredPhotos.length}</span> photo(s) shown
              </span>
            ...
            <div className="p-8">
              ...
              >
                ...
                <p className="text-xs text-gray-400">
                  Accepted formats: JPG, PNG, WEBP • Max size: 10 MB per file
                </p>
              </div>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ul className="text-xs text-blue-800 space-y-1">
                  ...
                  <li>• Make sure photos are sharp and high quality</li>
          ...
          <div className="absolute top-0 left-0 right-0 p-6 flex items-center justify-between z-10">
            <div className="flex items-center gap-4">
              ...
              <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                ...
                {currentPhoto.status === 'validated' ? 'Validated' : 'Rejected'}
              </span>
            </div>
            <button
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex items-center justify-between text-white">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="p-2 hover:bg-white/10 rounded-full transition-colors" title="Edit">
                    <Edit3 size={20} />
                  </button>
                  <button className="p-2 hover:bg-red-500/20 rounded-full transition-colors" title="Delete">
                    <Trash2 size={20} />
                  </button>
                </div>
              </div>
          ...
          <div className="max-w-4xl w-full">
            ...
            <div className="mt-6 flex items-center justify-between">
              <div className="text-white text-sm">
                <p>Move and resize the crop area</p>
                <p className="text-white/60 text-xs mt-1">
                  Zone: {Math.round(cropArea.width)}% x {Math.round(cropArea.height)}%
                </p>
              </div>
