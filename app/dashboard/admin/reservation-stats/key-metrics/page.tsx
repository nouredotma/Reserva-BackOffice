...
export default function SMEDashboard() {
  ...
  const dashboardData = {
    ...
    year: {
      ...
      appointmentsTrend: [
        ...
        { day: 'Feb', direct: 6, online: 152 },
        { day: 'Tue', direct: 9, online: 148 },
        { day: 'Apr', direct: 7, online: 156 },
        { day: 'May', direct: 5, online: 162 },
        { day: 'Jun', direct: 4, online: 158 },
        { day: 'Jul', direct: 3, online: 168 },
        { day: 'August', direct: 2, online: 172 },
        { day: 'Sep', direct: 4, online: 165 },
        { day: 'Oct', direct: 5, online: 159 },
        { day: 'Nov', direct: 3, online: 155 },
        { day: 'Dec', direct: 4, online: 156 },
      ],
      revenueData: [
        { name: 'Jan', value: 45200 },
        { name: 'Feb', value: 48800 },
        { name: 'Tue', value: 52400 },
  ...
  const serviceData = [
    ...
    { name: 'Accommodations', value: 280, color: '#3B82F6' },
    ...
    <div className="min-h-screen p-0">
      ...
      <div className="grid grid-cols-5 gap-4 mb-8 animate-fadeIn">
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6  transition-all group">
          ...
          <div>
            <p className="text-xs text-gray-400 mb-1">Namebre de reservations en ligne</p>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6  transition-all group">
          ...
          <div>
            <p className="text-xs text-gray-400 mb-1">Namebre de reservations</p>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6  transition-all group">
          ...
          <div>
            <p className="text-xs text-gray-400 mb-1">New online guests</p>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6  transition-all group">
          ...
          <div>
            <p className="text-xs text-gray-400 mb-1">New direct guests</p>
      ...
      <div className="bg-white rounded-lg border border-gray-100 p-6 mb-8 animate-fadeIn">
        <div className="mb-6">
          <h2 className="text-xl font-light text-gray-900 mb-1">Reservations pris</h2>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8 animate-fadeIn">
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Time slots populaires</h3>
            <p className="text-xs text-gray-400">Traffic by hour</p>
          </div>
          <ResponsiveContainer width="100%" height={240}>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Key metrics</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400">Duration moyenne</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400">Satisfaction guest</p>
      ...
      <div className="grid grid-cols-4 gap-4 mt-8 animate-fadeIn">
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs text-gray-400">Advance reservations</p>
            <div className="flex items-center gap-1 text-emerald-600">
              <ArrowUpRight size={12} />
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          ...
          <p className="text-xs text-gray-500">Par reservations</p>
        </div>

        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs text-gray-400">Loyal guests</p>
            <div className="flex items-center gap-1 text-emerald-600">
              <ArrowUpRight size={12} />
              <span className="text-[10px] font-medium">+12%</span>
            </div>
      ...
      <div className="grid grid-cols-2 gap-6 mt-8 animate-fadeIn">
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Times de pointe</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Canaux de reservation</h3>
          ...
          <div className="space-y-4">
            {[
              ...
              { channel: 'Phone', count: 18, percentage: 9, icon: <Phone size={18} className="text-foreground" /> },
      ...
      <div className="mt-8 animate-fadeIn">
        <div className="mb-6">
          <h2 className="text-2xl font-light text-gray-900 mb-1">Analyse guests</h2>
          <p className="text-xs text-gray-400">Demographics and behavior</p>
        </div>

        <div className="grid grid-cols-3 gap-6">
          <div className="bg-white rounded-lg border border-gray-100 p-6">
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-900 mb-1">Breakdown by age</h3>
              <p className="text-xs text-gray-400">Distribution des guests</p>
            </div>
            <div className="space-y-3">
              {[
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-6">
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-900 mb-1">Visit frequency</h3>
              <p className="text-xs text-gray-400">Comportement guest</p>
            </div>
            <div className="space-y-4">
              {[
                { type: 'Regulars', desc: 'Weekly', count: 45, color: '#FFC900' },
                { type: 'Frequent', desc: 'Twice monthly', count: 89, color: '#3B82F6' },
                { type: 'Occasionnels', desc: 'Mensuel', count: 124, color: '#60A5FA' },
                { type: 'New', desc: 'First visit', count: 28, color: '#93C5FD' },
              ].map((segment, index) => (
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-6">
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-900 mb-1">Time preferences</h3>
              <p className="text-xs text-gray-400">Moments favoris</p>
            </div>
            <div className="space-y-4">
              {[
                { day: 'Mondi', morning: 35, afternoon: 45, evening: 20 },
                { day: 'Tuedi', morning: 40, afternoon: 38, evening: 22 },
                { day: 'Wedcredi', morning: 32, afternoon: 48, evening: 20 },
                { day: 'Thudi', morning: 38, afternoon: 42, evening: 20 },
                { day: 'Fridredi', morning: 30, afternoon: 45, evening: 25 },
                { day: 'Satedi', morning: 25, afternoon: 52, evening: 23 },
              ].map((day, index) => (
                <div key={index}>
                  <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center justify-center gap-4 pt-3 border-t border-gray-100 mt-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] text-gray-500">Afternoon</span>
                </div>
                <div className="flex items-center gap-1.5">
