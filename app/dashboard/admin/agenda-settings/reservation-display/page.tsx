...
const GestionAffichageRDV = () => {
  ...
  const [fields, setFields] = useState<DisplayField[]>([
    ...
    { id: 'clientName', label: 'Guest name', visible: true, order: 2 },
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Customize the order and visibility of reservation information
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
              <div className="px-6 py-4 bg-gray-50 border-b border-gray-100">
                <h3 className="text-sm font-medium text-gray-900">Couleur dans la reservation</h3>
              </div>
              <div className="p-6">
                <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                  Show the resource color as the reservation background
                </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
              <div className="px-6 py-4 bg-gray-50 border-b border-gray-100">
                <h3 className="text-sm font-medium text-gray-900 mb-1">
                  Information order and visibility
                </h3>
                <p className="text-xs text-gray-500">
                  Drag to reorder, enable, or disable fields
                </p>
              </div>
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1 min-w-0">
                        {fields.filter(f => f.visible).sort((a, b) => a.order - b.order).map(field => {
                          switch (field.id) {
                            case 'clientName':
                              return <p key={field.id} className="font-medium truncate break-words w-full">Guest name</p>;
                            case 'services':
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100">
                    ...
                    <div className="flex items-center justify-between text-sm mt-3">
                      ...
                      <span className="text-gray-900 font-medium">
                        {showColorInRDV ? 'Enabled' : 'Disabled'}
                      </span>
                    </div>
                  </div>
                </div>
