        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage Reserva offers, capacity, pricing, and reservation rules
            </p>
          </div>
      ...
      <div className="space-y-8 animate-fadeIn">
        ...
        {filteredServices.length === 0 && (
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
            <p className="text-gray-400 mb-4">No offer found</p>
            <button
              onClick={() => {
                setSearchQuery('');
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl  max-w-md w-full p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-gray-900">New category</h3>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-colors"
                >
                  Create
                </button>
              </div>
...
const ServiceRow = ({ service, isLast, onEdit, onDelete, onDuplicate, onDragStart }: {
  ...
  const getVisibilityText = () => {
    if (service.visibility === 'bookable') return 'Bookable';
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-500">
            ...
            <span className="flex items-center gap-1 font-medium text-gray-900">
              ...
              {service.priceType === 'from' && `From ${service.priceFrom} MAD`}
      ...
      <div className="space-y-2 text-xs">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${
            ...
            {service.visibility === 'bookable' ? 'Bookable' : service.visibility === 'visible' ? 'Visible' : 'Hidden'}
          </span>
        </div>
      </div>
    </div>
...
const ServiceModal = ({ service, categories, collaborators, onClose, onSave }: {
        ...
        <div className="sticky top-0 bg-white border-b border-gray-100 px-8 py-6 rounded-t-2xl z-10">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-light text-gray-900">
              {service ? 'Edit une offre' : 'New offre'}
            </h2>
            <button
              onClick={onClose}
              className="p-2 text-gray-400 hover:text-gray-900 transition-colors"
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Example: Reinforced semi-permanent polish | Short nails"
                />
              </div>
              ...
              <div className="md:col-span-3">
                ...
                <Select value={formData.priceType} onValueChange={v => setFormData({ ...formData, priceType: v as 'fixed' | 'from' | 'range' })}>
                  <SelectTrigger className="w-full px-4 py-2.5 rounded-full bg-gray-50 border border-gray-200 text-sm mt-2">
                    <SelectValue placeholder="Select le type de prix" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      aria-label="Decrease le prix minimum"
                    >
                      -
                    </button>
                    <input
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        aria-label="Decrease le prix maximum"
                      >
                        -
                      </button>
                      <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select value={formData.visibility} onValueChange={v => setFormData({ ...formData, visibility: v as 'bookable' | 'visible' | 'hidden' })}>
                  ...
                  <SelectContent>
                    <SelectItem value="bookable">Bookable offer</SelectItem>
                    <SelectItem value="visible">Visible but not bookable</SelectItem>
                    <SelectItem value="hidden">Hidden on portal</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
          ...
          {showAdvanced && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500">
                Select the resources that can manage this offer
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="multipleProviders" className="text-sm text-gray-700">
                    Several resources can manage this offer at the same time
                  </label>
                </div>
              </div>
            </div>
