    ...
    <div className="min-h-screen">
      ...
      <div className="mb-8 pt-20 animate-slideUp">
        <div className="flex items-center justify-between">
          <div className="flex items-baseline gap-4">
            <h1 className="text-5xl font-light text-gray-900 tracking-tight">Detected duplicates</h1>
          ...
          {filteredDuplicates.map((dup) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-gray-100">
                <div className="text-xs text-gray-400 mb-2">Detected duplicates:</div>
      ...
      {filteredDuplicates.length === 0 && (
        <div className="bg-white rounded-lg border border-gray-100 p-12 text-center animate-fadeIn">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No duplicate detected</h3>
          <p className="text-gray-500 text-sm mb-6">
            {searchTerm ? 'Essayez de modifier votre recherche' : 'All vos guests sont uniques !'}
          </p>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white rounded-lg  max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slideUp">
            ...
            <div className="px-8 py-6">
              <h3 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-4">Guests to merge</h3>
              <div className="space-y-4">
                <div className="flex gap-4">
                  <div className="flex-1 bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="text-xs text-gray-400">Status: {selectedDuplicate.status}</div>
                  </div>
                ...
                <div className="mt-6 text-sm text-gray-700">
                  <strong>Merge these guests?</strong> The information will be combined and the duplicates will be removed.
                </div>
              </div>
              {/* Actions */}
