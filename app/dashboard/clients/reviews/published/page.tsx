...
export default function ReviewsModeresPage() {
    ...
    <div className="min-h-screen">
      ...
      <div className="mb-8 pt-20 animate-slideUp">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-5xl font-light text-gray-900 tracking-tight mb-2">Moderated reviews</h1>
          ...
          {filteredReviews.map((review) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3 flex-wrap">
                ...
                <span className={`px-2.5 py-1 rounded-full text-[11px] font-medium ${review.isPublic ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-600'}`}>{review.isPublic ? 'Public' : 'Private'}</span>
              </div>
              <div className="mb-4">
                    ...
                    <div>
                      ...
                      {review.replyDate && (
                        <span className="text-[10px] text-blue-600">
                          {format(new Date(review.replyDate), 'dd MMM yyyy', { locale: enUS })}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-[10px] font-medium text-gray-400 uppercase tracking-wider hidden md:table-cell">Status</th>
      ...
      {filteredReviews.length === 0 && (
        <div className="bg-white rounded-lg border border-gray-100 p-16 text-center animate-fadeIn">
          ...
          <h3 className="text-lg font-light text-gray-900 mb-2">No moderated reviews</h3>
          <p className="text-gray-400 text-sm">
            {searchTerm ? 'Essayez de modifier votre recherche' : 'Approved reviews will appear here'}
          </p>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg  max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slideUp">
            <div className="sticky top-0 bg-white border-b border-gray-100 px-8 py-6 z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-light accent-text">Reply to review</h2>
                </div>
                <button
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 px-8 py-4 flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-6 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Publish reply
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg  max-w-md w-full animate-slideUp">
            <div className="px-8 py-6">
              ...
              <p className="text-sm text-gray-600 text-center mb-6">
                This review will be removed from the list and sent back to pending moderation.
              </p>
            </div>
