...
export default function ReviewsRefusesPage() {
    ...
    <div className="min-h-screen">
      ...
      <div className="mb-8 pt-20 animate-slideUp">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-5xl font-light text-gray-900 tracking-tight mb-2">Rejected reviews</h1>
            <p className="text-sm text-gray-400">
              {filteredReviews.length} {filteredReviews.length === 1 ? 'reviews' : 'reviews'}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8 animate-fadeIn">
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Total rejected</span>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Average rating</span>
            <div className="w-8 h-8 rounded-full bg-red-50 flex items-center justify-center">
          ...
          {filteredReviews.map((review) => (
            ...
            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-gray-400">
                        {format(new Date(review.date), 'dd MMM yyyy', { locale: enUS })}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-2 mb-3 flex-wrap">
                ...
                <span className="px-2.5 py-1 rounded-full text-[11px] font-medium bg-red-50 text-red-700">Rejected</span>
              </div>
              <div className="mb-4">
                    ...
                    <div>
                      ...
                      {review.rejectedDate && (
                        <span className="text-[10px] text-red-600">
                          {format(new Date(review.rejectedDate), 'dd MMM yyyy', { locale: enUS })}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-[10px] font-medium text-gray-400 uppercase tracking-wider hidden xl:table-cell">Resource</th>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-[10px] text-gray-400 truncate">{format(new Date(review.date), 'dd MMM yyyy', { locale: enUS })}</div>
                        </div>
                      </div>
                    </td>
      ...
      {filteredReviews.length === 0 && (
        <div className="bg-white rounded-lg border border-gray-100 p-16 text-center animate-fadeIn">
          ...
          <h3 className="text-lg font-light text-gray-900 mb-2">No rejected reviews</h3>
          <p className="text-gray-400 text-sm">
            {searchTerm ? 'Essayez de modifier votre recherche' : 'Rejected reviews will appear here'}
          </p>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg  max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slideUp">
            <div className="sticky top-0 bg-white border-b border-gray-100 px-8 py-6 z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-light accent-text">Rejected review details</h2>
                </div>
                <button
                  ...
                  <div className="bg-red-50 rounded-lg p-4 mt-4">
                    ...
                    {selectedReview.rejectedDate && (
                      <p className="text-xs text-red-600 mt-2">
                        Rejected le {format(new Date(selectedReview.rejectedDate), "dd MMMM yyyy 'at' HH:mm", { locale: enUS })}
                      </p>
                    )}
                  </div>
                )}
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 px-8 py-4 flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-6 py-2.5 bg-primary text-primary-foreground text-sm font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-colors flex items-center justify-center gap-2"
              >
                <RotateCcw size={16} />
                Restaurer
              </button>
          ...
          <div className="bg-white rounded-lg  max-w-md w-full animate-slideUp">
            <div className="px-8 py-6">
              ...
              <h2 className="text-xl font-medium text-gray-900 text-center mb-2">
                Restaurer cet reviews ?
              </h2>
              <p className="text-sm text-gray-600 text-center mb-6">
                This review will be sent back to pending moderation for another review.
              </p>
            </div>
