...
export default function StatistiquesReviewsPage() {
    ...
    <div className="min-h-screen">
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        <div className="col-span-2 bg-white rounded-lg border border-gray-100 p-6 animate-fadeIn">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Tendance des reviews</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6 animate-fadeIn">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Breakdown</h3>
            <p className="text-xs text-gray-400">Status des reviews</p>
          </div>
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs text-gray-500">Rejecteds</span>
      ...
      <div className="grid grid-cols-2 gap-6 animate-fadeIn">
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-400">Breakdown by stars</p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="mb-6">
            <h3 className="text-sm font-medium text-gray-900 mb-1">Rating trend</h3>
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 animate-fadeIn">
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs text-gray-400">Reviews positifs</p>
            <div className="flex items-center gap-1 text-emerald-600">
        ...
        <div className="bg-white rounded-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs text-gray-400">Vues par reviews</p>
            <div className="flex items-center gap-1 text-emerald-600">
              <ArrowUpRight size={12} />
      ...
      <div className="mt-8 animate-fadeIn">
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-400">Statistiques individuelles par ressource</p>
        </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="text-center">
                    <p className="text-xs text-gray-400 mb-1">Reviews received</p>
                  ...
                  {/* Response Rate */}
                  <div className="text-center">
                    <p className="text-xs text-gray-400 mb-1">Replys</p>
