...
const formatDate = (date: Date, format: 'short' | 'long' = 'short') => {
  ...
  const months = ['Jan', 'Feb', 'Tue', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
...
export default function ReviewsAModererPage() {
    ...
    <div className="min-h-screen">
      ...
      <div className="mb-12 pt-20 animate-slideUp">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-5xl font-light text-gray-900 tracking-tight mb-2">Moderation</h1>
            <p className="text-sm text-gray-400">
              {filteredReviews.length} {filteredReviews.length === 1 ? 'pending reviews' : 'pending reviews'}
            </p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 px-3 py-2 bg-primary text-primary-foreground text-xs font-medium rounded-full hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer transition-colors flex items-center justify-center gap-1.5"
                >
                  <ThumbsUp size={12} />
                  Approuver
                </button>
      ...
      {filteredReviews.length === 0 && (
        <div className="bg-white rounded-lg border border-gray-100 p-16 text-center animate-fadeIn">
          ...
          <h3 className="text-lg font-light text-gray-900 mb-2">No pending reviews</h3>
          <p className="text-gray-400 text-sm">
            {searchTerm ? 'Modifiez votre recherche' : 'All reviews have been processed'}
          </p>
        </div>
      )}
          ...
          <div className="bg-white rounded-lg  max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slideUp">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-light accent-text">
                    {actionType === 'approve' ? 'Approuver l\'reviews' : 'Rejeter l\'reviews'}
                  </h2>
                </div>
                <button
            ...
            <div className="px-8 py-6">
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <p className="text-xs">
                  {actionType === 'approve'
                    ? 'This review will be published and visible to all visitors.'
                    : 'This review will be archived and will not be published.'}
                </p>
              </div>
            </div>
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 px-8 py-4 flex gap-3">
              ...
              <button
                ...
                className={`flex-1 px-6 py-2.5 text-white text-sm font-medium rounded-full transition-colors ${
                  actionType === 'approve'
                    ? 'bg-primary text-primary-foreground hover:bg-[var(--reserva-ink)] hover:text-white cursor-pointer'
