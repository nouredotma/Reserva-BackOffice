    ...
    <div className='w-full'>
      <div className='relative'>
        ...
        <Input
          ...
          className='w-full pl-10 pr-4 py-2.5 border-2 border-neutral-200 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-sm bg-white appearance-none [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none [&::-webkit-datetime-edit-fields-wrapper]:px-0'
        />
      </div>
    </div>
  )
